...
const Userprofile = () => {
  ...
  const colour=(value)=>{
    ...
    return <div class="text-blue-500 text-lg">Resedule</div>;
  };
  ...
  return (
   ...
   <form class="w-full max-w-xl bg-white rounded-lg px-4 pt-2">
      <div class="flex flex-wrap -mx-3 mb-3">
         <h2 class="px-4 pt-3 pb-2 text-gray-800 text-lg">posponment of meeting</h2>
         <div class="w-full md:w-full px-3 mb-2 mt-2">
            <textarea  onInput={msg} class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white" name="body" placeholder='Type Your reasone' required></textarea>
         </div>
            ...
            <div class="flex items-start w-1/2 text-gray-700 px-2 mr-auto">
               ...
               <p class="text-xs md:text-sm pt-px">Some HTML is okay.</p>
                ...
                <div class="mt-6 grid grid-cols-2 gap-4">
                  ...
                  <button  onClick={()=> updateNo(val)} class="w-full rounded-xl border-2 border-black-500 bg-white px-3 py-2 font-semibold  hover:bg-red-400 hover:text-white">For Resedulemnt</button>
                </div>
              </div>
            </div>
          </div>
