...
export default function Navbar() {
    return (
        <div>
            ...
            <button type="button" className="text-white bg-[#7286D3] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg font-medium text-sm px-5 py-2.5 text-center mr-3 md:mr-0">Get started</button>
            </div>
            ...
            <li>
                <NavLink to="/information" className="block hover:text-indigo-600">
                    <button class="py-1 px-3">
                        Information
                    </button>
                </NavLink>
