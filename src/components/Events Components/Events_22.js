...
import wmhd from "../../Images/event2022/wmhd.png";
import joy_web from "../../Images/event2022/be_joy_webinar.png";
import mmm_talk from "../../Images/event2022/MMM_talk.jpg";
import ug_talk from "../../Images/event2022/ug_talk.jpg";
import plantation_drive from "../../Images/event2022/plantation_drive.jpg";
import digi_detox from "../../Images/event2022/digi_detox.jpg";
...
export const Event2k22= [
    ...
    },
    {
        ...
        desc:"First Interactive Faculty Advisor meeting with first year BTech students of 2023 batch and their parents was organized on 27th October 2022, it aims to facilitate interaction between Faculty Advisors, Student Mentors, first year btech students and their parents. Second Interactive Faculty Advisor meeting with  first year BTech students of 2023 batch was held on 1st December in which after meeting Director sir, Dean of Academic Affairs, Dean of student affairs and Head, Counselling services addressed to the students and answered their doubts and issues and given the tips for the preparation of the upcoming mid-semester examination. Third Interactive Faculty Advisor meeting with  first year BTech students and first year students of PG programme of 2022 batch was held on 17th February in which after a student mentor and faculty advisor meeting, Director sir addressed the students and answered their concerns.",
        talk:"",
        details:"",
        activities:"",
    },
