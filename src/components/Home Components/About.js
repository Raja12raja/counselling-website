...
export default function WhoAreWe() {
    return(
        <div className="justify-between">
            ...
            <img src={counselorImg} alt="This is us" className="mx-44 my-12 w-2/5 h-2/5 float-left"/>
            <div className="mx-12 my-12 h-2/5 leading-loose font-bold" style={{fontFamily: 'Inconsolata'}}>University life can be fun and fulfilling, providing the students various opportunities to acquire new skills 
