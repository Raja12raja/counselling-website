...
export default function WhoAreWe() {
    return(
        <div className="justify-between">
            ...
            <div className="mx-12 my-12 h-2/5 leading-loose">University life can be fun and fulfilling, providing the students various opportunities to acquire new skills 
