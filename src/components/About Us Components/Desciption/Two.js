...
export default function Two(){
    return(
        <div className="lg:container mx-auto flex md:px-16 px-10 md:flex-row flex-col items-center">
            ...
            <p className="leading-relaxed lg:flex-grow md:w-1/2 lg:pl-12 md:pl-8 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                The counsellor Ms. Monika Gupta (M.Phil, Clinical Psychology, NIMHANS, and Bangalore) is available to provide help and support for students from diverse religious, cultural and ethnic backgrounds.
